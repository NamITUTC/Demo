package com.example.nam.demobasekotlin.ui.main.pathologicalInfor
 ...
 */
class PathologicalInforFragment : BaseFragment() {
    @Inject lateinit var presenter: PathologicalInforPresenter
    ...
    private inner class GetHtmlFromUrl() : AsyncTask<Void, Void, String>() {
        ...
        override fun doInBackground(vararg voids: Void): String {
            try {
                ...
                if (document != null) {
                    this.html = (document!!.select(".post-tile entry-title")).toString() + (document!!.select(".main-content")).toString().replace("href=".toRegex(), "").replace("width=".toRegex(), "width=390px")
                } else {
    ...
    override fun initData() {
        ...
        url = bundle.getString(Constant.LINKINFORPATHOLOGICAL)
